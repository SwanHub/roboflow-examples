  ...
  return (
    ...
    >
      <div className="flex items-start gap-2 px-4 flex-wrap">
        <Link
          href="https://roboflow.com/?ref=roboflow-examples-not-hotdog.vercel.app"
          target="_blank"
        ...
        <Link
          href="https://nextjs.org?ref=roboflow-examples-not-hotdog.vercel.app"
          target="_blank"
          rel="noopener noreferrer"
          className="focus:outline-none focus:ring-2 focus:ring-blue-500 rounded flex items-center gap-2 hover:underline"
        ...
        <Link
          href="https://vercel.com/?ref=roboflow-examples-not-hotdog.vercel.app"
          target="_blank"
          rel="noopener noreferrer"
          className="focus:outline-none focus:ring-2 focus:ring-blue-500 rounded flex items-center gap-2 hover:underline"
